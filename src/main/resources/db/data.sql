...
이번 전시의 프로젝트는 잘 만들었다 또는 못 만들었다는 기준이 없으며, 미술이라고 해도 되고, 아니라고 해도 되는, 딱히
 ...
 것을 만들고, 그 안에서 뜻밖의 아름다움을 발견하는 계기가 되길 기대한다.', '20230506','20230510','연령무관','20,000','10,000','0',2, 2 ,4),   
...
된 곳이다.', '20230406','20230411','연령무관','20,000','10,000','0',2, 2 ,5),
...
프로그램 완료 시 미술관 굿즈도 제공되니 많은 참여 바랍니다.', '20230504','20230505','유치부, 초등 저학년','0','0','5,000',2, 3 ,11),
('마르쿠스 슈텐츠와 조슈아 벨.png','손주이의 즹즹 콘서트','비 제 - 교향곡 제1번 다장조 1악장 생상스 - 첼로 협주곡 2번 라단조 Op.119 풀랑크 - 두 대의 피아노를 위한 협주곡 비 제 - <카르멘> 모음곡 제1번 & 제2번 발췌', '20230508','20230509','연령무관','50,000','30,000','10,000',2, 1 ,9),
('마르쿠스 슈텐츠와 조슈아 벨.png','김효린의 링링 토크 콘서트','토크 주제 - 김효린의 개발과정 - 초대손님 손주이,김근호', '20230516','20230518','연령무관','15,000','30,000','10,000',2, 1 ,2);



INSERT INTO show_datetime_tb(show_date, show_time , show_id)
VALUES ('20230502', '17:00', 1),
 ('20230502', '19:00', 1),
 ('20230503', '18:00', 1),
 ('20230503', '19:00', 1),
 ('20230504', '18:00', 1),
