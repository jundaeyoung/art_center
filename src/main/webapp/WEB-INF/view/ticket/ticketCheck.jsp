			...
			<div class="ticket--content">
				<div>
					<div class="ticket--img">
						<img alt="" src="/images/${ticketListInfo.imgRoute}" width="300"
							height="400">
					</div>
				</div>
					...
					<form action="/pay/payment/${ticketListInfo.id}" method="get">
						<div class="ticket--info">
							...
							<div class="ticket--hole">
								<h2>${ticketListInfo.name}&nbsp&nbsp&nbsp&nbsp${ticketListInfo.seatName}</h2>
							</div>
							<div class="ticket--date">
								<h2>날짜 : ${ticketListInfo.showDate}&nbsp&nbsp&nbsp&nbsp시간 :
									${ticketListInfo.showTime}</h2>
							</div>
							<div class="ticket--price">
								<c:choose>
									<c:when test="${userAge>19}">
										<h2>[성인]&nbsp&nbsp&nbsp&nbsp${ticketListInfo.adultRate}</h2>
									</c:when>
									<c:otherwise>
										<h2>
											[청소년]&nbsp&nbsp&nbsp&nbsp${ticketListInfo.youthRate}
											</h2>
									</c:otherwise>
								</c:choose>
							</div>
