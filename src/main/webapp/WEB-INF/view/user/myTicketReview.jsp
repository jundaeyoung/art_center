				...
				<c:choose>
					<c:when test="${myTicketList.reviewContent == null}">
						<form action="/myPage/myReviewWrite?showId=${myTicketList.showId}" class="mb-3" name="myform" id="myform" method="post">
							<input type="hidden" value="${myTicketList.ticketId}" name="ticketingId">
							<div class="star-input" style="width: 120px; margin-left: -20px;">
								<span class="input"> <input type="radio" name="rating" value="1" id="p1${myTicketList.ticketId}"> <label for="p1${myTicketList.ticketId}" style="width: 30px; z-index: 9;">1</label>
									<input type="radio" name="rating" value="2" id="p2${myTicketList.ticketId}"> <label for="p2${myTicketList.ticketId}" style="width: 60px; z-index: 7;">2</label> <input type="radio"
									name="rating" value="3" id="p3${myTicketList.ticketId}"> <label for="p3${myTicketList.ticketId}" style="width: 90px; z-index: 5;">3</label> <input type="radio" name="rating" value="4"
									id="p4${myTicketList.ticketId}"> <label for="p4${myTicketList.ticketId}" style="width: 120px; z-index: 3;">4</label> <input type="radio" name="rating" value="5"
									id="p5${myTicketList.ticketId}"> <label for="p5${myTicketList.ticketId}" style="width: 150px; z-index: 1;">5</label>
								</span>
							</div>
							<div>
