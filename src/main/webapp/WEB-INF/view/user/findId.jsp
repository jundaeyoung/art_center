...
<div class="container">
	<div class="signInContainer">
		<div class="loginContainer">
			...
			<c:choose>
				<c:when test="${userName == null}">
					<div class="selectIdAndPw" style="font-size: 20px; margin-left: 540px;">
					...
					<div class="logobox">
						...
						<div class="naverLogo">
							<a href="https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=q3WIWBEaLw_SUTxgY8kb&state=randomtext&redirect_uri=http://localhost:8080/auth/naver/callback"> <img alt=""
								src="/images/btn_naver.png" class="naverLogo">
							</a>
						</div>
		...
		&response_type=code&scope=https://www.googleapis.com/auth/userinfo.email"><img
				...
				<c:when test="${userName != null}">
					<h2 style="margin-left: 60px;">고객님 아이디 찾기가 완료 되었습니다.</h2>
					<div class="findIdContainer">
					<div class="find--info">
						<div>nickname : ${userName.nickname}</div>
						<div>email : ${userName.email}</div>
						<div style="margin-bottom: 50px;">귀하의 아이디는 ${userName.userName}입니다</div>
					</div>
					<div class="button--contatiner">
						...
						<button class="button" style="padding: 15px 70px">비밀번호 찾기</button>
						</form>
						</div>
						</div>
					<div class="botton--text">
						<p>고객님의 아이디 찾기가 성공적으로 이루어졌습니다.</p>
						<p>항상 고객님의 편의를 위해 노력하는 아마데우스가 되겠습니다.</p>
						<p>감사합니다.</p>
					</div>
				</c:when>
			</c:choose>
