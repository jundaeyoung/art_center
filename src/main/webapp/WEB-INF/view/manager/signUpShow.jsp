			...
			<div style="display: flex; width: 1400px; flex-direction: row; justify-content: space-between;">
				<div style="height: 500px; display: flex; flex-direction: column">
					<div style="margin-bottom: -10px; margin-left: -25px;">
						<label for="file" style="width: 200px; margin-right: 80px; margin-top: -10px;">이미지 : </label>
						<div class="filebox">
							<input class="upload-name" value="첨부파일" placeholder="첨부파일"> <label for="file">이미지 </label> <input type="file" name="file" id="file" accept=".jpg,.jpeg,.png" style="width: 300px;">
						</div>
					</div>
					<div class="date">
						<label for="content">날짜 : </label> <input type="text" id="startDate" name="startDate" style="width: 300px;" />
					</div>
					<div>
					...
					<div>
						...
						<textarea id="content" name="content" style="resize: none; height: 100px; width: 420px;"></textarea>
					</div>
					<!-- <div>
					...
					<div>
						<label for="age">연령제한 : </label><select id="age" name="admissionAge" style="width: 220px;">
