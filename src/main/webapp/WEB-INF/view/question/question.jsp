...
<div class="menu">
	...
	<div>
		<a href="/quest/info?category=안내&currentPage=1&begin=0&range=5"><button
				id="info">안내</button></a>
	</div>
	<div>
		<a href="/quest/info?category=대관&currentPage=1&begin=0&range=5"><button
				id="rent__place">대관</button></a>
	</div>
	<div>
		<a href="/quest/info?category=아카데미&currentPage=1&begin=0&range=5"><button
				id="academy">아카데미</button></a>
	</div>
	<div>
		<a href="/quest/info?category=모집&currentPage=1&begin=0&range=5"><button
				id="recruitment">모집</button></a>
	</div>
</div>
