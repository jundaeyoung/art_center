						...
						<tbody>
							<c:forEach var="ticketList" items="${ticketList}">
								<fmt:parseNumber var="adultRate" type="number"
									value="${ticketList.adultRate}" />
								<fmt:formatNumber value="${ticketList.adultRate}"
									pattern="#,##0" var="formattedAdultRate" />
								<fmt:parseNumber var="youthRate" type="number"
									value="${ticketList.youthRate}" />
								<fmt:formatNumber value="${ticketList.youthRate}"
									pattern="#,##0" var="formattedYouthRate" />
								<c:set var="totalAdultPrice"
									value="${ticketList.adultRate * ticketList.adultCount}" />
								<c:set var="totalYouthPrice"
									value="${ticketList.youthRate * ticketList.youthCount}" />
								...
								<c:set var="totalPrice"
									value="${totalAdultPrice+totalYouthPrice}" />
								...
								<tr>
									...
									<th>${formattedAdultRate}</th>
									<th>${formattedYouthRate}</th>
