         ...
         <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
               ...
               <div class="card-body">
                  ...
                  <form action="/admin/announcement/board" method="get" style="display: flex; justify-content: flex-end;">
                     <button type="submit" class="btn" style="display: flex; justify-content: flex-end; border: 1px solid #ccc;">글쓰기</button>
                  </form>
               </div>
            </div>
         </div>
