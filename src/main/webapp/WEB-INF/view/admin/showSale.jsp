   ...
   <main>
      <div class="fouc">
         <div style="padding: 0 30px">
            <h1 class="mt-4" style="margin-bottom: 30px;">공연 매출 보기</h1>
                  ...
                  <table id="datatablesSimple">
                     ...
                     <tbody>
                        <c:forEach var="showSalesList" items="${showSalesList}">
                           <fmt:formatNumber value="${showSalesList.adultRate}" pattern="#,##0" var="formattedAdultRate" />
                           <fmt:formatNumber value="${showSalesList.youthRate}" pattern="#,##0" var="formattedYouthRate" />
                           <fmt:formatNumber value="${showSalesList.totalshowSales}" pattern="#,##0" var="formattedTotal" />
                           ...
                           <tr>
                              ...
                              <td>${formattedAdultRate}</td>
                              <td>${formattedYouthRate}</td>
