					...
					<nav>
						<div id="nav">
							<ul class="main">
								<li><a href="#"> 공연 </a>
									<ul class="sub">
										<li><a href="/schedule">전체 공연 일정</a></li>
										<li><a href="/manager/schedule/${principal.id}">나의 공연 일정</a></li>
										<li><a href="/manager/showSale?currentPage=1&begin=0&range=5">공연 매출</a></li>
