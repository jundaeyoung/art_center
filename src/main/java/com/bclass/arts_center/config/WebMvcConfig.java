...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(loginInterceptor).addPathPatterns("/ticket/**")
				.addPathPatterns("/quest/insert/**").addPathPatterns("/user/delete").addPathPatterns("/user/update");
...
//				.addResourceLocations("file:///C:\\spring_upload\\arts_center\\upload/");
		.addResourceLocations("file:////Users/artsCenter");
	}
